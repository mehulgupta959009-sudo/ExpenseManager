function Footer() {
  return (
    <footer className="w-full bg-gradient-to-b from-gray-900 to-black text-gray-400">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pt-16 pb-12">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-white font-bold text-lg">TimePass</span>
            </div>
            <p className="text-sm text-gray-500 max-w-xs">
              Manage your items efficiently with our modern collection app.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 py-8 mt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-gray-500">
            &copy; 2024 TimePasse. All rights reserved.
          </p>
