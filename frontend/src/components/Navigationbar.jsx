...
function Navigationbar() {
  ...
  const handler2 = () => {
    dispatch(uiStatusActions.Logout());
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {logStatus.login ? (
            <Link to="/signup">
              <button
                className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-2 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-95"
                onClick={handler2}
              >
                Log Out
              </button>
